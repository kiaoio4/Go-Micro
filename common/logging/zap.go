...
func CreateLogger(basicConfig *microConf.BasicConfig, logConfig *conf.LogConfig) (*zap.Logger, error) { // logger, error
	...
	zlog := zap.New(
		...
		zap.Fields(
			zapcore.Field{Key: "zone", Type: zapcore.StringType, String: basicConfig.Zone},
			zapcore.Field{Key: "node", Type: zapcore.StringType, String: basicConfig.Node},
			zapcore.Field{Key: "machine", Type: zapcore.StringType, String: basicConfig.Machine},
			zapcore.Field{Key: "instance", Type: zapcore.StringType, String: basicConfig.Instance},
			zapcore.Field{Key: "service", Type: zapcore.StringType, String: basicConfig.Service},
			zapcore.Field{Key: "appname", Type: zapcore.StringType, String: basicConfig.AppName},
			zapcore.Field{Key: "appversion", Type: zapcore.StringType, String: basicConfig.AppVersion},
		),
	)
	return zlog, err
}
